...
%%%%%%%%%%%
    ...
    %----------------------------
     ...
     % Verifica si se ha cargado el MiR100 o se abre una ventana para seleccionar
    ...
    if hasTopic('/odom')
        ...
        for k = 1:n
            ...
            odom.yaw(k) = quatToYaw(q);  % Conversión de cuaternión a Yaw. 
        end
    ...
    %----------------------------
     ...
     % El mismo proceso para 1) ODOMETRÍA (/odom) se realiza para 2) LÁSER (/scan)
